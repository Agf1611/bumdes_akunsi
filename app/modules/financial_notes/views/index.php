...
<div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
    <div>
        ...
        <p class="text-secondary mb-0">Laporan penjelas untuk mendampingi Laba Rugi, Neraca, Arus Kas, dan Perubahan Ekuitas. Cocok dipakai sebagai pelengkap paket LPJ atau laporan tahunan BUMDes.</p>
    </div>
