...
final class QuickJournalController extends Controller
{
    ...
    private function readInput(): array
    {
        return [
            ...
            'business_unit_id' => trim((string) post('business_unit_id', current_business_unit_id() > 0 ? (string) current_business_unit_id() : '')),
    ...
    private function showForm(string $templateKey, ?array $preview, array $oldInput): void
    {
        ...
        $formData = [
            ...
            'business_unit_id' => old('business_unit_id', (string) ($oldInput['business_unit_id'] ?? (current_business_unit_id() > 0 ? current_business_unit_id() : ''))),
