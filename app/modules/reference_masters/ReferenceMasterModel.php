...
final class ReferenceMasterModel
{
    private const CONFIG = [
        ...
        'cashflow-components' => [
            ...
            'type_field' => 'component_group',
            'type_options' => [
                'OPERATING_IN' => 'Operasi Masuk',
                'OPERATING_OUT' => 'Operasi Keluar',
                'INVESTING_IN' => 'Investasi Masuk',
                'INVESTING_OUT' => 'Investasi Keluar',
                'FINANCING_IN' => 'Pendanaan Masuk',
                'FINANCING_OUT' => 'Pendanaan Keluar',
                'OTHER' => 'Lainnya',
            ],
            'search_fields' => ['component_code', 'component_name', 'component_group', 'description'],
            'usage_table' => 'journal_lines',
